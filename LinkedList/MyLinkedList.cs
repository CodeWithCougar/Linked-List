...
namespace LinkedList
{
    internal class MyLinkedList
    {
        ...
        public void deleteAtPosition(int pos)
        {
            ...
            // We update 'temp's next pointer to skip the node at the desired position,
        ...
        public void deleteByKey(int key)
        {
            ...
            // We initialize 'prev' to null and 'temp' to the head of the list.
            Node prev = null;
            Node temp = head;

            // We move 'temp' forward until we either reach the end of the list or find the node that contains the key.
            // We also move 'prev' forward along with 'temp' so that 'prev' always points to the node before 'temp'.
            ...
            // If 'temp' is null, it means we've reached the end of the list and haven't found the key.
            if (temp == null)
            {
            ...
            // If 'temp' is not null, it means we've found the node that contains the key.
